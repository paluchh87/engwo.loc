...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 16 2019 г., 22:26
...
--
-- Структура таблицы `words_dictionary`
--
...
--
-- Индексы таблицы `words_dictionary`
--
ALTER TABLE `words_dictionary`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `words_log`
--
ALTER TABLE `words_log`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `words_dictionary`
--
ALTER TABLE `words_dictionary`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `words_log`
--
ALTER TABLE `words_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
